...
public class TestingForGraph {
    ...
    public void fieldTest()
        ...
        cl9.ClassWith9Field();
        cl9.setClassWith4Fields(cl8);
        cl8.setClassWith4Fields(cl7);
        cl7.setClassWith4Fields(cl6);
        cl6.setClassWith5Fields(cl5);
        cl5.setClassWith4Fields(cl4);
        cl4.setClassWith3Fields(cl3);
        cl3.setClassWith2Fields(cl2);
        cl2.setClassWith1Fields(cl1);
        cl1.setClassWith0Fields(cl0);
        ...
        for (int i = 0; i < 10; i++) {
            ...
            System.out.println(
                "numof fields " + (long) Math.pow(2, i + 3) + "\t\t\t" + (end - start) / 10 + "\t" +
                    (end2 - start2) / 10 + "\t" + (end3 - start3) / 10 + "\t"
                    + (End3 - Start3) / 10);
        }
    }
}
