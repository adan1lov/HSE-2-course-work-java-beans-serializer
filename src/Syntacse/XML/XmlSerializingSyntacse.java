...
public class XmlSerializingSyntacse implements SerializingSyntacse {
    ...
    @Override
    public void primitive(String type, String name, Object param, FileOutputStream output, int tabs,
        ...
        output.write(
            ("\t" + tabString + "<" + type + ">" + param + "</" + type + ">" + "\n").getBytes());
        output.write((tabString + "</void>\n").getBytes());

    }

    @Override
    public void nonPrimitiveBegin(String type, String name, FileOutputStream output, String id,
        int tabs, int index, boolean superObject) throws IOException {
//        <object class="com.company.A" id="10">
        ...
        output.write(
            (tabString + "<object class=\"" + type + "\" id=\"" + id + "\">" + "\n").getBytes());
    }

    @Override
    public void nonPrimitiveEnd(String type, String name, FileOutputStream output, int tabs,
    ...
    @Override
    public void arrayBegin(String type, String name, FileOutputStream output, String id, int tabs,
        ...
        output.write(
            (tabString + "<array class=\"" + type + "\" id=\"" + id + "\" length=\"" + length
                + "\">" + "\n").getBytes());
    }

    @Override
    public void arrayEnd(String type, String name, FileOutputStream output, int tabs, int index,
    ...
    @Override
    public void itarableBegin(String type, String name, FileOutputStream output, String id,
        int tabs, int index, boolean superObject) throws IOException {
        StringBuilder tabString = new StringBuilder();
        for (int i = 0; i < tabs; i++) {
            tabString.append('\t');
...
//            output.append(tabString+"<void method=\"add\">\n");
    ...
    @Override
    public void iterableEnd(String type, String name, FileOutputStream output, int tabs, int index,
        boolean superObject) throws IOException {
    ...
    @Override
    public void reference(String type, String name, String id, FileOutputStream output, int tabs,
        int index) throws IOException {
